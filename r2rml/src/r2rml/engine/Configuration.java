...
public class Configuration {
	...
	public Configuration(String input, String map, String output, String format) throws R2RMLException {
		Properties properties = new Properties();
		try {
			properties.load(new FileInputStream(new File(input)));
		} catch (IOException e) {
			throw new R2RMLException(e.getMessage(), e);
		}

		try {
			properties.load(new FileInputStream(new File(map)));
		} catch (IOException e) {
			throw new R2RMLException(e.getMessage(), e);
		}
